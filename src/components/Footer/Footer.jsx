    ...
    return (
        <footer className='w-full mt-10 border-t-2'>
            <div className="mx-auto w-full max-w-7xl px-8 flex flex-col">
                ...
                <div className="grid grid-cols-6 md:grid-cols-6 grid-rows-1">
                    <ul className='flex flex-col md:col-span-1 col-span-2 row-span-1 row-start-1 md:col-start-6 col-start-4 items-start'>
                        <Typography
                            variant="small"
                            color="blue-gray"
                    ...
                    <ul className='flex flex-col md:col-span-1 col-span-2 row-span-1 row-start-1 md:col-start-5 col-start-2 items-start justify-start'>
                        <Typography
                            variant="small"
                            color="blue-gray"
                            className="mb-3 font-medium opacity-40"
                        ...
                        <li>
                        <NavLink to={`/Proyecto-React-REGAHARD/cart`}>
                            <Typography
                            as="p"
                            color="gray"
                            className="py-1.5 font-normal transition-colors hover:text-blue-gray-900"
                        ...
                        <li>
                        <NavLink to={`/Proyecto-React-REGAHARD/categoria/Checkout`}>
                            <Typography
                            as="p"
                            color="gray"
                            className="py-1.5 font-normal transition-colors hover:text-blue-gray-900"
                ...
                <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
                    ...
                    >
                        &copy; {currentYear} Made by Gonzalo Billia.
                    </Typography>
